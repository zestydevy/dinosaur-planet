        ...
        with open(c_path, "w", encoding="utf-8") as c_file:
            ...
            if dll.number >= 210:
                if obj_data_size != None and obj_data_size != 0:
                    ...
                    c_file.write(f"}} DLL{dll.number}_Data;\n")
            ...
            for func_rodata in dll.function_rodata:
                if func_rodata.function == None:
                    ...
                    if not self.__try_auto_decomp(dll, func, ctor_dtor, export_idx, obj_data_size, c_file):
            ...
            if export_idx == 0:
                ...
                if obj_data_size != None:
                    ...
                    if obj_data_size == 0:
                        ...
                        c_file.write(f'    return sizeof(DLL{dll.number}_Data);\n')
                    c_file.write('}\n')
                    return True
                else:
                    c_file.write(f'u32 {func.getName()}(Object *self, u32 a1);\n')
