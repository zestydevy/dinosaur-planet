...
f32 curves_b_spline(f32* s, f32 t, f32* rate) {
    ...
    if (rate != NULL) {
        *rate = (((((3.0f * v[0]) * t) + (2.0f * v[1])) * t) + v[2]) * ONE_OVER_SIX;
    }
...
f32 curves_catmull_rom(f32* s, f32 t, f32* rate) {
    ...
    v[0] = -s[0] + (3.0f * s[1]) + (-3.0f * s[2]) + s[3];
    v[1] = (2.0f * s[0]) + (-5.0f * s[1]) + (4.0f * s[2]) - s[3];
    v[2] = -s[0] + s[2];
    v[3] = 2.0f * s[1];
...
void curves_move(CurvesStruct *arg0) {
    ...
    while (arg0->unk10 < (arg0->numControlPoints - 3)) {
        curves_func_800065C0(arg0, 5);
    ...
    if (arg0->unk80 != 0) {
        arg0->unk10 = arg0->numControlPoints - 4;
    } else {
        arg0->unk10 = 0;
    }

    curves_func_800065C0(arg0, 0x14);
    ...
    if (arg0->unk84 != NULL) {
        arg0->unk68.x = arg0->splineFunc(arg0->unk84, arg0->unk0, &arg0->unk74);
    }
    if (arg0->unk88 != NULL) {
        arg0->unk68.y = arg0->splineFunc(arg0->unk88, arg0->unk0, &arg0->unk78);
    }
    if (arg0->unk8C != NULL) {
        arg0->unk68.z = arg0->splineFunc(arg0->unk8C, arg0->unk0, &arg0->unk7C);
    }
}
...
s32 curves_func_800053B0(CurvesStruct* arg0, f32 arg1) {
    ...
    if (var_fs0 > 0.0f) {
        ...
        while (var_fs0 > 0.0f) {
            ...
            if (var_fs0 > 0.0f) {
                ...
                if (var_v1 >= 20) {
                    ...
                    arg0->unk10 += 1;
                    if ((arg0->numControlPoints - 4) < arg0->unk10) {
                        if (arg0->unk84 != NULL) {
                            arg0->unk68.x = arg0->splineFunc(&arg0->unk84[var_t0], 1.0f, &arg0->unk74);
                        }
                        if (arg0->unk88 != NULL) {
                            arg0->unk68.y = arg0->splineFunc(&arg0->unk88[var_t0], 1.0f, &arg0->unk78);
                        }
                        if (arg0->unk8C != NULL) {
                            arg0->unk68.z = arg0->splineFunc(&arg0->unk8C[var_t0], 1.0f, &arg0->unk7C);
                        }
                        arg0->unk4 = 0.0f;
                        arg0->unk10 = arg0->numControlPoints - 4;
                        arg0->unk0 = 1.0f;
        ...
        var_v1 = 0;
        if (arg0->unk84 != NULL) {
            arg0->unk68.x = arg0->splineFunc(&arg0->unk84[arg0->unk10], temp_fs1, &arg0->unk74);
        }
        if (arg0->unk88 != NULL) {
            arg0->unk68.y = arg0->splineFunc(&arg0->unk88[arg0->unk10], temp_fs1, &arg0->unk78);
        }
        if (arg0->unk8C != NULL) {
            arg0->unk68.z = arg0->splineFunc(&arg0->unk8C[arg0->unk10], temp_fs1, &arg0->unk7C);
        }
        arg0->unk0 = temp_fs1;
        arg0->unk4 = var_fs0;
        arg0->unk80 = 0;
        ...
        while (var_fs0 < 0.0f) {
            ...
            if (var_fs0 < 0.0f) {
                ...
                if (var_v1 < 0) {
                    ...
                    if (arg0->unk10 < 0) {
                        if (arg0->unk84 != NULL) {
                            arg0->unk68.x = arg0->splineFunc(&arg0->unk84[var_t0], 0.0f, &arg0->unk74);
                        }
                        if (arg0->unk88 != NULL) {
                            arg0->unk68.y = arg0->splineFunc(&arg0->unk88[var_t0], 0.0f, &arg0->unk78);
                        }
                        if (arg0->unk8C != NULL) {
                            arg0->unk68.z = arg0->splineFunc(&arg0->unk8C[var_t0], 0.0f, &arg0->unk7C);
                        }
                        arg0->unk0 = 0.0f;
                        arg0->unk4 = -s1[1];
                        arg0->unk8 = 0.0f;
...
void curves_func_800065C0(CurvesStruct *arg0, s32 arg1) {
    ...
    if (arg0->splineConverterFunc != NULL) {
        curves_func_8000598C(phi_s4, phi_s5, phi_s6, xCoords, yCoords, zCoords, arg1, arg0->splineConverterFunc);
    } else {
...
f32 curves_func_80006784(Unk80006784* arg0, s32 arg1, f32 arg2, f32 arg3) {
    f32 temp_fv0;
    f32 temp_fv0_2;
    f32 temp_fv1;
    f32 var_fs0;
    ...
    do {
        ...
        temp_fv0_2 = curves_func_80006CFC(temp_s0, var_fs1, temp_fv0);
...
f32 curves_func_80006908(Unk80006908* arg0, s32 arg1, f32 arg2) {
    f32 temp_fa0;
    f32 temp_fv0;
    f32 var_ft4;
    f32 var_ft5;
...
void curves_func_80006B28(Vec2f* arg0, s32 arg1, Unk80006908* arg2) {
    f32 sp88[4];
    f32 sp78[4];
    f32 sp68[4];
    s32 var_a1;
...
f32 curves_func_80006CFC(Unk80006784 *arg0, f32 arg1, f32 arg2) {
    f32 var_fs0;
    f32 sp48;
    f32 var_fs1;
    s32 i;
    ...
    for (i = 2; i < 0x1A; i++) {
        if (!(i & 1)) {
            var_fs1 += 4.0f * curves_func_80006E04(arg0, var_fs0);
        } else {
            var_fs1 += 2.0f * curves_func_80006E04(arg0, var_fs0);
        }
        var_fs0 += sp48;
    }
    var_fs0 = curves_func_80006E04(arg0, arg1);
    return ((curves_func_80006E04(arg0, arg2) + (var_fs0 + var_fs1)) * sp48) / 3.0f;
}

f32 curves_func_80006E04(Unk80006784* arg0, f32 arg1) {
...
void curves_func_80006E58(CurvesStruct* arg0, f32 arg1, f32 arg2, s32 arg3) {
    ...
    var_fa1 = 0.0f;
    var_ft4 = 0.0f;
    for (var_v0 = 0; var_v0 < arg0->numControlPoints; var_v0 += 4) {
        if (arg0->unk84 != NULL) {
