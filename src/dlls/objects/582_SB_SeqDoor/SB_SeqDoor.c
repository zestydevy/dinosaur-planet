...
/*00*/ ObjSetup base;
/*18*/ s8 yaw;
/*19*/ s8 alternateModel;
} SB_SeqDoor_Setup;

static int SB_SeqDoor_anim_callback(Object *self, Object *animObj, AnimObj_Data *animObjData, s8 prevCallbackValue);
...
void SB_SeqDoor_setup(Object *self, SB_SeqDoor_Setup *setup, s32 reset) {
    self->animCallback = SB_SeqDoor_anim_callback;
    self->srt.yaw = setup->yaw << 8;
    self->modelInstIdx = setup->alternateModel != 0;
}
...
void SB_SeqDoor_free(Object *self, s32 onlySelf) { }
...
u32 SB_SeqDoor_get_data_size(Object *self, u32 offsetAddr) {
    return 0;
}

// offset: 0xFC | func: 7
int SB_SeqDoor_anim_callback(Object *self, Object *animObj, AnimObj_Data *animObjData, s8 prevCallbackValue) {
    animObjData->unk7A = -2;
    animObjData->unk62 = 0;
    return 0;
}
