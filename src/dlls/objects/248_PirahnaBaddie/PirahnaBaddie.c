    ...
    if (self->unkDC != 0) {
        ...
        if (objdata->unk18 > 0.0f) {
            ...
            if (func_8002601C(self, &sp60, &sp40, &sp3C, &sp50, &sp4C, &sp48) != 0) {
                ...
                gDLL_33_BaddieControl->vtbl->drop_collectable(self, (s32) setup->unk18, -1, 0);
...
static void dll_248_func_A5C(Object* self, PirahnaBaddie_Data* objdata) {
    ...
    self->srt.roll = (s16) ((mathSinfInterp((s16) objdata->unk28) + mathSinfInterp((s16) objdata->unk2A)) * 1000.0f);
    self->srt.pitch = (s16) ((mathSinfInterp((s16) objdata->unk28) + mathSinfInterp((s16) objdata->unk2C)) * 1000.0f);
    if (objdata->flags & 2) {
    ...
    var_v1 = mathAtan2f(
        ...
        self->globalPosition.f[2] - objdata->player->globalPosition.f[2]) - (self->srt.yaw & 0xFFFF);
    CIRCLE_WRAP(var_v1);
