...
static void dll_587_func_548(Object* self);
static void dll_587_func_75C(Object* self, Gfx** gdl, Mtx** mtxs, Vtx_t** vtxs, Triangle** pols);

// offset: 0x0 | ctor
void dll_587_ctor(void* dll) { }

// offset: 0xC | dtor
void dll_587_dtor(void* dll) { }

// offset: 0x18 | func: 0 | export: 0
void dll_587_setup(Object* self, AnimObj_Setup* objSetup, s32 reset) {
...
void dll_587_control(Object* self) {
    s32 index;
    AnimObj_Data* objData;
...
void dll_587_update(Object* self) { }

// offset: 0x34C | func: 3 | export: 3
void dll_587_print(Object* self, Gfx** gdl, Mtx** mtxs, Vertex** vtxs, Triangle** pols, s8 visibility) {
    ...
    if ((sVanishMask.state == ModelMask_STATE_2_Contracting) || (sVanishMask.state == ModelMask_STATE_3_Expanding)) {
        dll_587_func_75C(self, gdl, mtxs, (Vtx_t**)vtxs, pols);
    }
...
void dll_587_free(Object* self, s32 onlySelf) {
    AnimObj_Data* objData;
    s32 i;
...
u32 dll_587_get_model_flags(Object* self) {
    return MODFLAGS_1 | MODFLAGS_SHADOW | MODFLAGS_8;
}

// offset: 0x534 | func: 6 | export: 6
u32 dll_587_get_data_size(Object* self, u32 offsetAddr) {
    return sizeof(DLL587_Data);
}

// offset: 0x548 | func: 7
void dll_587_func_548(Object* self) {
    AnimObj_Data* objData;
    s32 sp30;
...
// offset: 0x75C | func: 8
void dll_587_func_75C(Object* self, Gfx** gdl, Mtx** mtxs, Vtx_t** vtxs, Triangle** pols) {
    /*0x0*/ static const DLTri rodata_0[] = {
    ...
    /*0xC0*/ static const Vec3f rodata_C0[] = {
        VEC3F(-150, 0, -150), 
        VEC3F( 150, 0, -150), 
        VEC3F(-150, 0,  150), 
        VEC3F( 150, 0,  150),
    ...
    for (i = 0; i < ARRAYCOUNT(rodata_C0); i++) {
        ...
        if (i < 4) {
            vtx->ob[0] = rodata_C0[i].x * 3.0f;
            vtx->ob[2] = rodata_C0[i].z * 3.0f;
        } else {
            vtx->ob[0] = rodata_C0[i].x * 3.0f;
            vtx->ob[2] = rodata_C0[i].z * 3.0f;
        }
    ...
    srt.transl.z = self->globalPosition.f[2];
    srt.yaw = self->srt.yaw;
    srt.pitch = 0x7FFF;
    srt.roll = 0;
    srt.scale = 0.05f;
    ...
    i = 8;
    while (i--) {
        gDLL_17_partfx->vtbl->spawn(self, PARTICLE_55E, &srt, 2, -1, NULL);
    }
