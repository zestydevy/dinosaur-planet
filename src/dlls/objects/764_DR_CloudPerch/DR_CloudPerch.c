...
void DR_CloudPerch_setup(Object* self, DR_CloudPerch_Setup* setup, s32 reset) {
    ...
    obj_add_object_type(self, OBJTYPE_21);
    obj_add_object_type(self, OBJTYPE_DINOCALLER);
    objdata = self->data;
...
void DR_CloudPerch_free(Object* self, s32 onlySelf) {
    obj_free_object_type(self, OBJTYPE_21);
    obj_free_object_type(self, OBJTYPE_DINOCALLER);
}
