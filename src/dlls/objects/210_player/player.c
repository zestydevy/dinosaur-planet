    ...
    switch (player->curModAnimId) {
        ...
        case 0x12:
            ...
            if ((_bss_4 > 10.0f) && (fsa->unk4.unk25C & 0x10)) {
                ...
                gDLL_6_AMSFX->vtbl->play(player, spAC->unk898[func_80025CD4(fsa->unk4.unk68.unk50[0])], MAX_VOLUME, NULL, NULL, 0, NULL);
...
s32 dll_210_func_CC24(Object* player, ObjFSA_Data* fsa, f32 arg2) {
    ...
    case 0x54:
        ...
        if (fsa->unk4.unk25C & 0x10) {
            ...
            gDLL_6_AMSFX->vtbl->play(player, sp38->unk898[func_80025CD4(fsa->unk4.unk68.unk50[0])], MAX_VOLUME, NULL, NULL, 0, NULL);
...
s32 dll_210_func_F00C(Object* player, ObjFSA_Data* fsa, f32 arg2) {
    ...
    if (fsa->enteredAnimState != 0) {
        ...
        gDLL_2_Camera->vtbl->change_camera_module(DLL_ID_CAMCLIMB, 1, 1, 8, &sp6C, 0, 0);
...
s32 dll_210_func_1034C(Object* player, ObjFSA_Data* fsa, f32 arg2) {
    ...
    case 0x37:
        if (fsa->unk308 & 1) {
            gDLL_6_AMSFX->vtbl->play(player, (u16) temp_s2->unk898[func_80025CD4((s32) fsa->unk4.unk68.unk50[0])], MAX_VOLUME, NULL, NULL, 0, NULL);
        }
        if (fsa->unk33A != 0) {
...
s32 dll_210_func_10898(Object* player, ObjFSA_Data* fsa, f32 arg2) {
    ...
    if (player->curModAnimId == 0x41A) {
        ...
        gDLL_2_Camera->vtbl->change_camera_module(DLL_ID_CAMCLIMB, 1, 1, 8, &sp3C, 0, 0xFF);
...
s32 dll_210_func_10A0C(Object* player, ObjFSA_Data* fsa, f32 arg2) {
    ...
    if (fsa->enteredAnimState != 0) {
        ...
        gDLL_2_Camera->vtbl->change_camera_module(DLL_ID_CAMCLIMB, 1, 1, 8, &sp54, 0, 0);
