...
static void ChukaChuck_handlePlayerOrSidekickCollision(Object* self);
static void ChukaChuck_handleTerrainCollision(Object* self);
static int ChukaChuck_doesParentExist(Object* self);
...
void ChukaChuck_obj_Setup(Object* self, ChukaChuck_Setup* setup, s32 reset) {
    self->unkDC = 180;
    func_800267A4(self);
...
void ChukaChuck_obj_Control(Object* self) {
    ...
    if (self->objhitInfo->unk48 && 
        ...
        ChukaChuck_handlePlayerOrSidekickCollision(self);
        self->opacity = 0;
        self->unkDC = 120;
    ...
    if (self->objhitInfo->unk9D != 0) {
        ChukaChuck_handleTerrainCollision(self);
        self->opacity = 0;
        self->unkDC = 120;
        self->objhitInfo->unk58 &= ~1;
    }
...
void ChukaChuck_obj_Update(Object* self) { }

// offset: 0x2E0 | func: 3 | export: 3
void ChukaChuck_obj_Print(Object* self, Gfx** gdl, Mtx** mtxs, Vertex** vtxs, Triangle** pols, s8 visibility) {
    if (visibility) {
...
void ChukaChuck_obj_Free(Object* self, s32 onlySelf) {
    camIgnoreShake();
}

// offset: 0x374 | func: 5 | export: 5
u32 ChukaChuck_obj_GetModelFlags(Object* self) {
    return MODFLAGS_NONE;
}

// offset: 0x384 | func: 6 | export: 6
u32 ChukaChuck_obj_GetDataSize(Object* self, u32 offsetAddr) {
    return sizeof(ChukaChuck_Data);
}

// offset: 0x398 | func: 7
void ChukaChuck_handlePlayerOrSidekickCollision(Object* self) {
    s32 i;
    ...
    if (self->id == OBJ_ChukaChuck) {
        ...
        if (self->unkC4 && ChukaChuck_doesParentExist(self->unkC4)) {
            ((DLL_220_Chuka*)self->unkC4->dll)->vtbl->ReceiveMessage(self->unkC4, 0x80);
        }
    ...
    if (self->id == OBJ_IceBall) {
        ...
        if (self->unkC4 && ChukaChuck_doesParentExist(self->unkC4)) {
            ((DLL_216_SnowWorm*)self->unkC4->dll)->vtbl->ReceiveMessage(self->unkC4, 0x80);
        }
    ...
    if (self->id == OBJ_IceBallSmall) {
        ...
        if (self->unkC4 && ChukaChuck_doesParentExist(self->unkC4)) {
            ((DLL_222_SnowWormSmall*)self->unkC4->dll)->vtbl->ReceiveMessage(self->unkC4, 0x80, 0);
        }
...
// offset: 0x620 | func: 8
void ChukaChuck_handleTerrainCollision(Object* self) {
    s32 i;
...
// offset: 0x77C | func: 9
int ChukaChuck_doesParentExist(Object* thrownBy) {
    s32 index;
    s32 count;
    Object** objects;
