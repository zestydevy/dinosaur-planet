...
static Object* WL_DeadDino_create_magic_dust(Object* self) {
    ...
    magicSetup = obj_alloc_setup(sizeof(MagicDust_Setup), OBJ_MagicDustMid);
    magicSetup->unk1A = 20;
    magicSetup->unk2C = -1;
    magicSetup->unk1C = -1;
    ...
    return obj_create((ObjSetup*)magicSetup, OBJINIT_FLAG4 | OBJINIT_STANDALONE, self->mapID, -1, self->parent);
}
