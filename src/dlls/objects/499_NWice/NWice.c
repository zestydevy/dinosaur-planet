...
void dll_499_setup(Object* self, ObjSetup* setup, s32 arg2) {
    ...
    objAddObjectType(self, OBJTYPE_NWice);
}
...
void dll_499_control(Object* self) {
    ...
    if (objdata->unk0 != NULL) {
        ...
        objGetNearestTypeToExcludingSelf(OBJTYPE_NWice, self, &dist);
    ...
    objList = objGetAllOfType(OBJTYPE_NWanimice, &numObjs);
...
void dll_499_free(Object* self, s32 a1) {
    objFreeObjectType(self, OBJTYPE_NWice);
}
