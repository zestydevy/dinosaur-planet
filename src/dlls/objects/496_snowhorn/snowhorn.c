...
s32 dll_496_func_980(Object* snowhorn) {
    ...
    switch (snowhorn->curModAnimId) {
        case MODANIM_SnowHorn_Sleep_Intro:
            if (playSound) {
                gDLL_6_AMSFX->vtbl->dll_6_func_48C((void*)snowhorn, SFX_SNOWHORN_YAWN1, 0x7F, 0, 0, 0, 0);
            }
            if (animIsFinished) {
        ...
        case MODANIM_SnowHorn_Sleep:
            if (playSound) {
                gDLL_6_AMSFX->vtbl->dll_6_func_48C((void*)snowhorn, SFX_SNOWHORN_SNOREHORN, 0x7F, 0, 0, 0, 0);
            }
        ...
        case MODANIM_SnowHorn_Wake_Up:
            if (playSound) {
                gDLL_6_AMSFX->vtbl->dll_6_func_48C((void*)snowhorn, SFX_SNOWHORN_YAWN2, 0x7F, 0, 0, 0, 0);
            }
            if (animIsFinished) {
...
void dll_496_func_1D68(Object* self, SnowHornState* state, SnowHornCreateInfo* createInfo) {
    ...
    switch (state->flags) {
        case 0:
            ...
            if (state->unk8 >= 0x3E9) {
                gDLL_6_AMSFX->vtbl->dll_6_func_48C(self, 0x1E2, 0x7F, 0, 0, 0, 0);
        ...
        case 4:
            if (state->unk424 & 8) {
                ...
                if (weeds % 3 == 0) {
                    gDLL_6_AMSFX->vtbl->dll_6_func_48C(self, 0x74B, 0x7F, 0, 0, 0, 0);
