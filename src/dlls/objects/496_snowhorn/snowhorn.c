...
void dll_496_func_24C(Object* snowhorn) {
    ...
    if (state->unk424 & 1) {
        ...
        gDLL_27->exports->head_turn_func_1e8(snowhorn, sp34, delayFloat);
        gDLL_27->exports->head_turn_func_5a8(snowhorn, sp34);
        gDLL_27->exports->head_turn_func_624(snowhorn, sp34, delayFloat);
    }
