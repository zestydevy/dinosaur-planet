...
#ifndef AVOID_UB
static int dll_369_func_4D0(Object* actor, Object* animObj, AnimObj_Data* animObjData/*, s8*/);
#else
static int dll_369_func_4D0(Object* actor, Object* animObj, AnimObj_Data* animObjData, s8);
#endif
static s32 dll_369_func_1D84(Object*, Object**, s16, s16, s16, s32);
...
static s32 dll_369_func_2348(Object*, UnkCurvesStruct*, f32, u8, f32*);
static s32 dll_369_func_2700(UnkCFGuardianStruct*, s32, s32, s32);
static s32 dll_369_func_2790(Object*, UnkFunc_80024108Struct*, u16*);
static void dll_369_func_25AC(Object*, UnkCurvesStruct*, s32, s32, f32);
static s32 dll_369_func_2638(Object*, UnkCurvesStruct*, f32);
static void dll_369_func_1B8C(Object*, Object**, Collectable_Setup**);
...
void dll_369_obj_Setup(Object* self, CFGuardian_Setup* setup, s32 reset) {
    ...
    if (objdata != NULL) {
        ...
        STUBBED_PRINTF(" Initalise Guardian State %i ", objdata->unk8F8);
        ...
        self->unkDC = 1;
        self->animCallback = (AnimationCallback)dll_369_func_4D0;
...
void dll_369_obj_Free(Object* self, s32 onlySelf) {
    ...
    if (onlySelf == 0) {
        for (i = 0; i < 6; i++) {
            if (objdata->unk50C[i] != NULL) {
                objFreeObject(objdata->unk50C[i]);
            }
        }
    }
...
// offset: 0x4D0 | func: 7
#ifndef AVOID_UB
static int dll_369_func_4D0(Object* actor, Object* animObj, AnimObj_Data* animObjData/*, s8 arg3*/) {
#else
static int dll_369_func_4D0(Object* actor, Object* animObj, AnimObj_Data* animObjData, s8 arg3) {
#endif
    ...
    diPrintf(" TURN NECK ");
    if (((DLL_53_movelib*)gTempDLLInsts[1])->vtbl->func4(actor, animObjData, &temp_s2->unk0, var_v1->unk2, var_v1->unk4) != 0) {
        return 1;
    }
    if (animObjData->lastMessage == 2) {
        dll_369_func_1B8C(actor, temp_s2->unk50C, temp_s2->unk524);
        animObjData->unk9D |= 8;
    }
    if (animObjData->lastMessage == 3) {
        animObjData->unk9D |= 4;
    }
    dll_369_func_1D84(actor, temp_s2->unk50C, 0x500, 0, 0, 6);
    return 0;
}

// offset: 0x678 | func: 8
s32 dll_369_func_678(Object* self) {
    ...
    case 2:
        ...
        temp_s1->unk912 |= 2;
        if (dll_369_func_2348(self, &temp_s1->unk53C, 0.7f, 0, &temp_s1->unk67C) != 0) {
            temp_s1->unk8F8 = 3;
        }
        break;
    case 3:
        if ((temp_s1->unk0.unk498 == 1) && (sp90 == temp_s1->unk0.prevLookat) && (vec3Distance(&self->globalPosition, &sp90->globalPosition) < 80.0f)) {
        ...
        if (temp_s1->unk90C != 0) {
            if (temp_s1->unk90C >= 2) {
                ...
                if (sp84 <= 1.0f) {
                    ...
                    dll_369_func_1FF0(dll_369_func_2020(self, 0, NULL, 2), &temp_s1->unk8E0);
            ...
            if (temp_s1->unk90C < 2) {
                ...
                gDLL_27->vtbl->func_1E8(self, &temp_s1->unk680, gUpdateRateF);
                gDLL_27->vtbl->func_5A8(self, &temp_s1->unk680);
                gDLL_27->vtbl->func_624(self, &temp_s1->unk680, gUpdateRateF);
    ...
    case 7:
        ...
        temp_s1->unk912 |= 2;
        if (dll_369_func_2348(self, &temp_s1->unk53C, 0.3f, 1, &temp_s1->unk67C) != 0) {
            temp_s1->unk8F8 = 8;
            objAnim_func_80024D74(self, 0x32);
        }
        break;
    case 8:
        ...
        if ((temp_s1->unk912 & 4) && (dll_369_func_2104(self, &temp_s1->unk8E0, 0.5f, &temp_s1->unk67C) != 0)) {
            objAnimSet(self, 0x1A, 0, 0);
            temp_s1->unk912 &= ~0x5;
        }
    ...
    case 10:
        ...
        temp_s1->unk912 |= 2;
        if (dll_369_func_2348(self, &temp_s1->unk53C, 0.6f, 2, &temp_s1->unk67C) != 0) {
            temp_s1->unk8F8 = 0xB;
        }
        break;
    case 11:
    ...
    ((DLL_53_movelib*)gTempDLLInsts[1])->vtbl->func0(self, &temp_s1->unk0);
    ...
    if ((data_188[temp_s1->unk8F8] != -1) && !(temp_s1->unk912 & 1) && (self->curModAnimId != data_188[temp_s1->unk8F8])) {
        objAnimSet(self, data_188[temp_s1->unk8F8], 0, 0);
    ...
    if (objAnimAdvance(self, temp_s1->unk67C, (f32) gUpdateRate, &sp50) != 0) {
        if (temp_s1->unk912 & 1) {
            ...
            sp80 = dll_369_func_2700(data_168, self->curModAnimId, data_184, mathRnd(0, 1));
            if (sp80 != -1) {
    ...
    dll_369_func_2790(self, &sp50, data_0);
    if (mathRnd(0, 0x3C) == 0) {
    ...
    dll_369_func_1D84(self, temp_s1->unk50C, 0x500, 0, 0, 6);
    if (mainGetBits(0x4B) != temp_s1->unk8F8) {
        mainSetBits(0x4B, temp_s1->unk8F8);
...
static void dll_369_func_1B8C(Object* arg0, Object** arg1, Collectable_Setup** arg2) {
    Vec3f sp70[] = { // data_200
...
static s32 dll_369_func_1D84(Object* arg0, Object** arg1, s16 arg2, s16 arg3, s16 arg4, s32 arg5) {
    s16 spB0[3];
    Vec3f spA4;
    s32 var_s4;
    s32 sp9C = 0;
...
static s32 dll_369_func_2348(Object* self, UnkCurvesStruct* arg1, f32 arg2, u8 arg3, f32* arg4) {
    s32 _pad;
    s16 angle;
    s32 sp54;
    f32 sp50;
    ...
    if (self->unkDC == 0) {
        dll_369_func_1FF0(dll_369_func_2020(self, arg3, NULL, 2), &sp38);
        if (dll_369_func_2104(self, &sp38, arg2, arg4) != 0) {
            STUBBED_PRINTF("Got Curve ");
            dll_369_func_25AC(self, arg1, 2, arg3, 200.0f);
            self->unkDC = 1;
        }
    } else {
        sp54 = dll_369_func_2638(self, arg1, arg2);
        if (sp54 != 0) {
            self->unkDC = -1;
        }
...
static s32 dll_369_func_2700(UnkCFGuardianStruct* arg0, s32 arg1, s32 arg2, s32 arg3) {
    s32 i;
...
static s32 dll_369_func_2790(Object* arg0, UnkFunc_80024108Struct* arg1, u16* arg2) {
    s32 var_s2;
    u8 temp_t6;
    s32 i;
