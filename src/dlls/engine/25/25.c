...
void dll_25_func_D8(void) {
    ...
    curvesResult = gDLL_CURVES->exports->curves_func_1bc(&curvesCount);
    bzero(_bss_0, 0xD9);
    ...
    for (sp270 = 0; sp270 < curvesCount; sp270++) {
        ...
        if (temp_s4->unk19 == 0x26) {
            ...
            for (var_v1_2 = 0; var_v1_2 < 4; var_v1_2++) {
                ...
                if (var_s7->unk1C[0] >= 0) {
                    temp_v0_2 = gDLL_CURVES->exports->curves_func_39c(var_s7->unk1C[0]);
...
CurvesFunc1BCReturnInner* dll_25_func_1864(Vec3 arg0, s32 arg1, s32 arg2) {
    ...
    result = gDLL_CURVES->exports->curves_func_1bc(&count);
    out = NULL;
    var_fs0 = MAX_FLOAT;
    for (i = 0; i < count; i++) {
        ...
        if ((temp_s0 != NULL) 
            ...
            && ((arg2 == -1) || (arg2 == temp_s0->unk1A.bytes.unk1A)) 
