...
void dll_22_ctor(s32 arg0) {
    ...
    _bss_10[0].unk0 = queue_load_texture_proxy(0x27B);
    _bss_10[1].unk0 = queue_load_texture_proxy(0x27C);
    _bss_10[2].unk0 = NULL;
    _bss_10[0].unk8 = 0;
...
void dll_22_dtor(s32 arg0) {
    ...
    texture_destroy(_bss_10[0].unk0);
    texture_destroy(_bss_10[1].unk0);
}
