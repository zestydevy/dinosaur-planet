...
s32 BaddieControl_func_ED0(Object* arg0, Baddie* arg1, u8 arg2) {
    ...
    if ((arg0->parent == NULL) && (mapWorldCoordsToBlockIndex(arg0->srt.transl.x, arg0->srt.transl.y, arg0->srt.transl.z) < 0)) {
        return 0;
    }
    return 1;
}
...
Object* BaddieControl_func_15CC(Object* arg0, s32 arg1, s32 arg2, u8 arg3) {
    ...
    case 5:
        ...
        sp34 = 750.0f;
        temp_v0 = objGetNearestTypeTo(OBJTYPE_Collectable, arg0, &sp34);
