...
void dll_85_func_18(Cam* cam, s32 arg1, AttentionCam_Params* action) {
    ...
    ((DLL_84_camnormal*)camnormal->dll)->vtbl->func7(
        &bss_0->unk0, &bss_0->unk4, &bss_0->unk8, 0, &bss_0->unkC);
    bss_0->unk1B8 = 0;
    ...
    if (var_a0 < (s16) (action->unk0 * 182.04f)) {
        bss_0->unk1B8 = 1;
        return;
    }
    var_fa0 = SQ(bss_0->unk0) - SQ(bss_0->unk8);
    if (var_fa0 < 5.0f) {
        var_fa0 = 5.0f;
    }
    temp_fv0 = sqrtf(var_fa0);
    sp120.x = player->srt.transl.x + (sp130 * temp_fv0);
    sp120.y = player->srt.transl.y + bss_0->unkC + bss_0->unk8;
    sp120.z = player->srt.transl.z + (sp12C * temp_fv0);
    if (action->unk3 != 0) {
        player->srt.transl.y += bss_0->unkC;
    ...
    bss_0->unk11C.unk84 = bss_0->unk18;
    bss_0->unk11C.unk88 = bss_0->unk68;
    bss_0->unk11C.unk8C = bss_0->unkB8;
    bss_0->unk11C.splineFunc = curves_b_spline;
    bss_0->unk11C.splineConverterFunc = curves_b_spline_converter;
    dll_85_func_D70(
        var_fa0, 
        var_fa1, 
        cam->srt.transl.x, 
    ...
    var_v1 = spEC;
    while (var_v1 < (spEC + 3)) {
        bss_0->unk18[var_v1] = sp120.x;
        bss_0->unk68[var_v1] = sp120.y;
        bss_0->unkB8[var_v1] = sp120.z;
        var_v1 += 1;
    }
    bss_0->unk11C.numControlPoints = var_v1;
    bss_0->unk11C.unk80 = 0;
    curves_move(&bss_0->unk11C);
    if (sp14C < 0) {
        var_a0 = sp14C * -1;
    } else {
        var_a0 = sp14C;
    }
    if ((var_a0 >= 0x2000) && (action->unk2 != 0)) {
        gDLL_6_AMSFX->vtbl->play(player, SOUND_1E, MAX_VOLUME, NULL, NULL, 0, NULL);
    }
    gDLL_2_Camera->vtbl->func12(bss_0->unk11C.unkC, &bss_0->unk108, 20.0f, 0.5f, 1.0f, -10.0f);
    bss_0->unk10 = -100000.0f;
    bss_0->unk14 = 100000.0f;
}
...
void dll_85_func_B04(AttentionCam_Params* params, s32 arg1) {
...
static void dll_85_func_D70(f32 arg0, f32 arg1, f32 arg2, f32 arg3, f32 arg4, f32 arg5, s16 arg6, s16 arg7, s32* arg8) {
    ...
    spB4 = 0;
    dll_85_func_F84(spC0, &spB4, 0, var_s2, arg7);
    temp1 = arg2 - arg0;
    temp_fs0 = arg5 - arg3;
    temp2 = arg4 - arg1;
    var_s3 = 1;
    ...
    while (var_s3 < spB4) {
        ...
        bss_0->unk18[var_s4] = arg0 + sp94[0];
        bss_0->unk68[var_s4] = arg3 + (temp_fs0 * ((f32) spC0[var_s3] / (f32) var_s2));
        bss_0->unkB8[var_s4] = arg1 +  sp94[2];
        var_s3 += 1;
        var_s4 += 1;
    }
    *arg8 = var_s4;
...
static void dll_85_func_F84(s16* arg0, u16* arg1, s16 arg2, s16 arg3, s16 arg4) {
    if (arg3 >= arg4) {
        dll_85_func_F84(arg0, arg1, arg2, arg3 >> 1, arg4);
        dll_85_func_F84(arg0, arg1, arg2 + (arg3 >> 1), arg3 >> 1, arg4);
        return;
    }
    arg0[(*arg1)++] = arg2;
}
...
static s32 dll_85_func_112C(f32* arg0, f32* arg1, f32* arg2, Object* arg3) {
    ...
    if (bss_0->unk11C.unkC != 0.0f) {
        t = bss_0->unk11C.unk8 / bss_0->unk11C.unkC;
    } else {
        t = 0.0f;
    }
    if (t > 1.0f) {
    ...
    t = curves_hermite(&bss_0->unk108.x, t, NULL);
    if (t < 0.2f) {
        t = 0.2f;
    }
    temp_v0 = curves_func_800053B0(&bss_0->unk11C, t);
    *arg0 = bss_0->unk11C.unk68.x;
    *arg2 = bss_0->unk11C.unk68.z;
    return temp_v0;
}
...
static void dll_85_func_1374(Cam* cam, Object* arg1) {
    ...
    spB4.y = arg1->globalPosition.y + bss_0->unkC + bss_0->unk8;
