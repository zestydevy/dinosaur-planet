...
/*0x74*/ static s8 sJoyDisabledButtons = 0;
...
/**
  * Sets the disabled controller buttons for this tick of the command menu, affecting player control of the inventory.
  */
void cmdmenu_disable_buttons(u16 buttons) {
    sJoyDisabledButtons = buttons;
}
