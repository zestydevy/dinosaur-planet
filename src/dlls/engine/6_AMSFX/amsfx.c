...
void amSfx_SetVol(u32 soundHandle, u8 volume) {
    ...
    if (vol != (s8) sSndSlots[soundHandle].unk13) {
        ...
        if (temp_a0 == (sndstate* )-2) {
            mp3SetVolume(vol << 8, soundHandle * 0);
...
void amSfx_StopObject(Object *obj) {
    s32 i;
...
s32 amSfx_IsPlaying(u32 soundHandle) {
    if (soundHandle == 0) {
        return 0;
    }
...
s32 amSfx_FuncDCC(s32 arg0, UNK_TYPE_32 arg1, s32* arg2, s32* arg3) {
    *arg2 = 0;
    *arg3 = 0;
    return 0;
}
...
s32 amSfx_FlushCache(s32 arg0, UNK_TYPE_32 arg1) {
...
void amSfx_FreeObject(Object *obj) {
    s32 i;
    s32 temp = (!obj) && (!obj);
...
void amSfx_PlayCustom(Object* obj, u16 soundID, f32 pitch, f32 minDist, f32 maxDist, u32* soundHandle) {
    f32 pad;
    f32 temp2;
    f32 temp;
    f32 camX;
    ...
    if ((volume > 0) && (*soundHandle == 0)) {
        ...
        amSfx_SetPitch(*soundHandle, pitch);
    }
    if (*soundHandle != 0) {
        if (volume == 0) {
        ...
        amSfx_SetVol(*soundHandle, volume);
    }
}
...
void amSfx_UpdateDoppler(s32 soundHandle, Object* emitter, Object* listener, f32 arg3) {
    sndstate* sndpHandle;
    f32 pitch;
    f32 dist;
    f32 prevDist;
...
void amSfx_WaterFallsControl(void) {
    Object* player;
    s32 i;
    f32 distance;
    u32 lowVolume;
...
void amSfx_WaterFallsSetFlags(u8 flags) {
