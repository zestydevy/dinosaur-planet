...
void selection_draw(Gfx** gdl, Mtx** mtx, Vertex** vtx) {
    ...
    case SelectionMenu_STATE_3_Confirm_Left:
        ...
        fontWindowAddStringXY(1, CONFIRM_LEFT_TEXT_CANCEL_X,  CONFIRM_LEFT_TEXT_CANCEL_Y,  sGametext->strings[SelectionMenu_STRING_CANCEL],  1, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, CONFIRM_LEFT_TEXT_CONFIRM_X, CONFIRM_LEFT_TEXT_CONFIRM_Y, sGametext->strings[SelectionMenu_STRING_CONFIRM], 1, ALIGN_TOP_LEFT);
        
        //"Confirm" / "Cancel" text (main)
        fontWindowSetTextColour(1, 0, 0, 0, 0xFF, (((u8)sOpacity) * 0x96) >> 8);
        fontWindowAddStringXY(1, (CONFIRM_LEFT_TEXT_CANCEL_X  + SHADOW_X), (CONFIRM_LEFT_TEXT_CANCEL_Y  + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CANCEL],  2, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, (CONFIRM_LEFT_TEXT_CONFIRM_X + SHADOW_X), (CONFIRM_LEFT_TEXT_CONFIRM_Y + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CONFIRM], 2, ALIGN_TOP_LEFT);
        break;
    ...
    case SelectionMenu_STATE_2_Confirm_Right:
        ...
        //"Confirm" / "Cancel" text (drop-shadow)
        fontWindowSetTextColour(1, 0xFF, 0xD7, 0x3D, 0xFF, (u8)sOpacity);
        fontWindowAddStringXY(1, CONFIRM_RIGHT_TEXT_CANCEL_X,  CONFIRM_RIGHT_TEXT_CANCEL_Y,  sGametext->strings[SelectionMenu_STRING_CANCEL],  1, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, CONFIRM_RIGHT_TEXT_CONFIRM_X, CONFIRM_RIGHT_TEXT_CONFIRM_Y, sGametext->strings[SelectionMenu_STRING_CONFIRM], 1, ALIGN_TOP_LEFT);
        
        //"Confirm" / "Cancel" text (main)
        fontWindowSetTextColour(1, 0, 0, 0, 0xFF, (((u8)sOpacity) * 0x96) >> 8);
        fontWindowAddStringXY(1, (CONFIRM_RIGHT_TEXT_CANCEL_X  + SHADOW_X), (CONFIRM_RIGHT_TEXT_CANCEL_Y  + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CANCEL],  2, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, (CONFIRM_RIGHT_TEXT_CONFIRM_X + SHADOW_X), (CONFIRM_RIGHT_TEXT_CONFIRM_Y + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CONFIRM], 2, ALIGN_TOP_LEFT);
        break;
    ...
    case SelectionMenu_STATE_1_SwapStone_Choices:
        ...
        fontWindowSetTextColour(1, 0xFF, 0xD7, 0x3D, 0xFF, (u8)sOpacity);
        fontWindowAddStringXY(1, SWAPSTONE_TEXT_WARP_X, SWAPSTONE_TEXT_WARP_Y,  sGametext->strings[SelectionMenu_STRING_WARP], 1, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, SWAPSTONE_TEXT_SWAP_X, SWAPSTONE_TEXT_SWAP_Y,  sGametext->strings[SelectionMenu_STRING_SWAP], 1, ALIGN_TOP_RIGHT);
        fontWindowAddStringXY(1, SWAPSTONE_TEXT_SHOP_X, SWAPSTONE_TEXT_SHOP_Y,  sGametext->strings[SelectionMenu_STRING_SHOP], 1, -0x8000);
        
        //"Warp" / "Swap" / "Shop" text (main)
        fontWindowSetTextColour(1, 0, 0, 0, 0xFF, (((u8)sOpacity) * 0x96) >> 8);
        fontWindowAddStringXY(1, (SWAPSTONE_TEXT_WARP_X + SHADOW_X), (SWAPSTONE_TEXT_WARP_Y + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_WARP], 2, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, (SWAPSTONE_TEXT_SWAP_X + SHADOW_X), (SWAPSTONE_TEXT_SWAP_Y + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_SWAP], 2, ALIGN_TOP_RIGHT);
        fontWindowAddStringXY(1, (SWAPSTONE_TEXT_SHOP_X + SHADOW_X), (SWAPSTONE_TEXT_SHOP_Y + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_SHOP], 2, -0x8000);
        break;
    ...
    case SelectionMenu_STATE_4_Confirm_ShopKeeper:
        ...
        fontWindowSetTextColour(1, 0xFF, 0xD7, 0x3D, 0xFF, (u8)sOpacity);
        fontWindowAddStringXY(1, HAGGLE_TEXT_CHANGE_X,  HAGGLE_TEXT_CHANGE_Y,  sGametext->strings[SelectionMenu_STRING_CHANGE],  1, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, HAGGLE_TEXT_CANCEL_X,  HAGGLE_TEXT_CANCEL_Y,  sGametext->strings[SelectionMenu_STRING_CANCEL],  1, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, HAGGLE_TEXT_CONFIRM_X, HAGGLE_TEXT_CONFIRM_Y, sGametext->strings[SelectionMenu_STRING_CONFIRM], 1, ALIGN_TOP_LEFT);
        
        //"Change" / "Cancel" / "Confirm" text (main)
        fontWindowSetTextColour(1, 0, 0, 0, 0xFF, (((u8)sOpacity) * 0x96) >> 8);
        fontWindowAddStringXY(1, (HAGGLE_TEXT_CHANGE_X  + SHADOW_X), (HAGGLE_TEXT_CHANGE_Y  + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CHANGE],  1, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, (HAGGLE_TEXT_CANCEL_X  + SHADOW_X), (HAGGLE_TEXT_CANCEL_Y  + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CANCEL],  2, ALIGN_TOP_LEFT);
        fontWindowAddStringXY(1, (HAGGLE_TEXT_CONFIRM_X + SHADOW_X), (HAGGLE_TEXT_CONFIRM_Y + SHADOW_Y), sGametext->strings[SelectionMenu_STRING_CONFIRM], 2, ALIGN_TOP_LEFT);
        break;
    }
