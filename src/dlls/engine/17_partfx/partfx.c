...
s32 partfx_spawn(Object *obj, s32 id, SRT *transform, s32 flags, s8 arg4, void *data) {
    ...
    if (((id >= PARTICLE_384) && (id <= PARTICLE_3B4)) || ((id >= PARTICLE_5DD) && (id <= PARTICLE_640))) {
        ...
        if (_data_4 == NULL) {
            sLoadedDLLCount += 1;
            _data_4 = dllLoad(DLL_ID_FORCEPOINT_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_258) && (id <= PARTICLE_2BB)) {
        ...
        if (_data_8 == NULL) {
            sLoadedDLLCount += 1;
            _data_8 = dllLoad(DLL_ID_SHRINE_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_1F4) && (id <= PARTICLE_257)) {
        ...
        if (_data_C == NULL) {
            sLoadedDLLCount += 1;
            _data_C = dllLoad(DLL_ID_DIM_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_190) && (id <= PARTICLE_1F3)) {
        ...
        if (_data_10 == NULL) {
            sLoadedDLLCount += 1;
            _data_10 = dllLoad(DLL_ID_WM_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_C8) && (id <= PARTICLE_12B)) {
        ...
        if (_data_14 == NULL) {
            sLoadedDLLCount += 1;
            _data_14 = dllLoad(DLL_ID_NW_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_41A) && (id <= PARTICLE_44B)) {
        ...
        if (_data_18 == NULL) {
            sLoadedDLLCount += 1;
            _data_18 = dllLoad(DLL_ID_SWC_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_73A) && (id <= PARTICLE_76B)) {
        ...
        if (_data_1C == NULL) {
            sLoadedDLLCount += 1;
            _data_1C = dllLoad(DLL_ID_WC_PARTFX, 2);
        }
    ...
    if ((id == PARTICLE_84) || (id == PARTICLE_85) || ((id >= PARTICLE_8A) && (id <= PARTICLE_C7))) {
        ...
        if (_data_20 == NULL) {
            sLoadedDLLCount += 1;
            _data_20 = dllLoad(DLL_ID_SHP_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_3B6) && (id <= PARTICLE_3DD)) {
        ...
        if (_data_28 == NULL) {
            sLoadedDLLCount += 1;
            _data_28 = dllLoad(DLL_ID_BAY_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_352) && (id <= PARTICLE_383)) {
        ...
        if (_data_24 == NULL) {
            sLoadedDLLCount += 1;
            _data_24 = dllLoad(DLL_ID_CLF_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_32A) && (id <= PARTICLE_350)) {
        ...
        if (_data_2C == NULL) {
            sLoadedDLLCount += 1;
            _data_2C = dllLoad(DLL_ID_BAD_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_12C) && (id <= PARTICLE_18F)) {
        ...
        if (_data_30 == NULL) {
            sLoadedDLLCount += 1;
            _data_30 = dllLoad(DLL_ID_ICE_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_47E) && (id <= PARTICLE_4AF)) {
        ...
        if (_data_34 == NULL) {
            sLoadedDLLCount += 1;
            _data_34 = dllLoad(DLL_ID_REX_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_4B0) && (id <= PARTICLE_4E1)) {
        ...
        if (_data_38 == NULL) {
            sLoadedDLLCount += 1;
            _data_38 = dllLoad(DLL_ID_DIMBOSS_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_3E8) && (id <= PARTICLE_419)) {
        ...
        if (_data_3C == NULL) {
            sLoadedDLLCount += 1;
            _data_3C = dllLoad(DLL_ID_SWH_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_44C) && (id <= PARTICLE_47D)) {
        ...
        if (_data_40 == NULL) {
            sLoadedDLLCount += 1;
            _data_40 = dllLoad(DLL_ID_DF_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_6D7) && (id <= PARTICLE_707)) {
        ...
        if (_data_44 == NULL) {
            sLoadedDLLCount += 1;
            _data_44 = dllLoad(DLL_ID_DAK_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_708) && (id <= PARTICLE_739)) {
        ...
        if (_data_48 == NULL) {
            sLoadedDLLCount += 1;
            _data_48 = dllLoad(DLL_ID_MMP_PARTFX, 2);
        }
    ...
    if ((id >= PARTICLE_76C) && (id <= PARTICLE_79D)) {
        ...
        if (_data_4C == NULL) {
            sLoadedDLLCount += 1;
            _data_4C = dllLoad(DLL_ID_BWC_PARTFX, 2);
        }
