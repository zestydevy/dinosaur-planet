...
void func_8006AB80(f32 outputrate, f32 arg1, f32 arg2, f32 *arg3, f32 *arg4) {
	f32 sp24;
	f32 sp20;
	f32 sp1c;
	...
	sp24 = atan2f(arg1 * M_PI_F, outputrate);
	sp20 = sp24 * sp24;
...
void func_8006AEC4(struct fx *fx, f32 outputrate) {
	...
	func_8006AB80(outputrate, fx->unk00 + 10.0f, fx->unk02 / 10.0f, sp30, sp24);
